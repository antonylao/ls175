...
class AppTest < Minitest::Test
  ...
  def teardown
    FileUtils.rm(datafile_path) if File.exist?(datafile_path)
  end
  ...
  def test_add_new_expense
    ...
    assert_equal true, File.exist?(datafile_path)
    ...
    assert_includes File.read(datafile_path), entry
